...
class Player(pygame.sprite.Sprite):
    def __init__(self, screen, x, y):
        ...
        self.gun = []
        for i in range(20):
            self.gun.append(pygame.image.load(image_util.getImage(f'survivor-move_handgun_{i}.png')))

        self.shotgun = []
        for i in range(20):
            self.shotgun.append(pygame.image.load(image_util.getImage(f'survivor-move_shotgun_{i}.png')))

        self.machine = []
        for i in range(20):
            self.machine.append(pygame.image.load(image_util.getImage(f'survivor-move_rifle_{i}.png')))
    ...
    def change_weapon(self, key):
        self.image = pygame.image.load(image_util.getImage(self.player_weapon.image))
