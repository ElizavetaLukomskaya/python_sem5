    ...
    def start_wave(self, target):
        for i in range(self.amount):
            ...
            if a and b:
                ...
                y = random.randint(-100 - int(Background.display_scroll[1]), self.maxY + 100 - int(Background.display_scroll[1]))
            if a and not b:
                x = random.randint(self.posX- int(Background.display_scroll[0]), self.posX + 100- int(Background.display_scroll[0]))
                y = random.randint(-100- int(Background.display_scroll[1]), self.maxY+100 - int(Background.display_scroll[1]))
            if b and not a:
                x = random.randint(-100- int(Background.display_scroll[0]), self.posX + 100- int(Background.display_scroll[0]))
                y = random.randint(-100- int(Background.display_scroll[1]), 0- int(Background.display_scroll[1]))
            if not a and not b:
                x = random.randint(-100- int(Background.display_scroll[0]), self.posX + 100- int(Background.display_scroll[0]))
                y = random.randint(self.maxY- int(Background.display_scroll[1]), self.maxY+100- int(Background.display_scroll[1]))
